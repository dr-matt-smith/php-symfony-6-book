...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/9fd62910f505d54b27171036acbf12dafc5b8057.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/1ed3d02a50a2750e79c73555fde09e2b4117bd0f.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/4e20ebf6b80bf441fbc12d17c09ac3680e146cf1.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/99d1c7b61646671719a4ba00450a74787e31b522.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/4372c0edcc841710e99167f5f25657ffd5c0aaef.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/f0902fccf036efafb73d57fda9a541beba454125.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/76a4f1af025bb43ea8894fe24899f7e9550b20e3.png}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/76e5b763019278beefe14f1d51b591897b69e764.png}
...
\begin{Highlighting}[]
    ...
    \KeywordTok{public} \KeywordTok{function}\NormalTok{ show}\OtherTok{(}\KeywordTok{$id}\OtherTok{)}\NormalTok{: Response}
\NormalTok{    \{}
        \KeywordTok{$studentRepository}\NormalTok{ = }\KeywordTok{new}\NormalTok{ StudentRepository}\OtherTok{();}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/023e41aab54996f415924222c82f5ca0297f4d6a.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/b66452000a3a5aa4ea5946995e99460914a2e6d5.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/362b681e24aa9da80460f615378c7ff8663ced77.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/ce432826e1e4e2f0dc4cdf1e248d79b4fbcd967f.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/853af1a5f83374e71ec3d4bc9dfa20b84e661e85.png}
\caption{Listing all database student records with route
...
\NormalTok{    \{}
        ...
        \KeywordTok{$cat1}\NormalTok{->setName}\OtherTok{(}\StringTok{'hardware'}\OtherTok{);}
        ...
        \KeywordTok{$cat2}\NormalTok{->setName}\OtherTok{(}\StringTok{'kitchenware'}\OtherTok{);}
...
Now we need to also add 2 named references to these \texttt{Category}
objects so we can retrieve references to them in our \texttt{Product}
fixtures class:
...
\NormalTok{    \{}
        ...
        \KeywordTok{$this}\NormalTok{->addReference}\OtherTok{(}\StringTok{'CATEGORY_HARDWARE'}\OtherTok{,} \KeywordTok{$cat1}\OtherTok{);}
        \KeywordTok{$this}\NormalTok{->addReference}\OtherTok{(}\StringTok{'CATEGORY_KITCHENWARE'}\OtherTok{,} \KeywordTok{$cat2}\OtherTok{);}
\NormalTok{    \}}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}

\hypertarget{product-class}{%
\section{Product class}\label{product-class}}

Create a class \texttt{Product} with properties:
...
\item
  \texttt{name} String
\item
  \texttt{category} ManyToOne relation to class \texttt{Category}
\end{itemize}

\hypertarget{productfixtures-class}{%
\section{ProductFixtures class}\label{productfixtures-class}}

Create a class \texttt{ProductFixtures} and create 2 \texttt{Product}
objects for ``hammer'' and ``plunger'' the usual way:
...
\KeywordTok{class}\NormalTok{ ProductFixtures }\KeywordTok{extends}\NormalTok{ Fixture}
\NormalTok{\{}
    \KeywordTok{public} \KeywordTok{function}\NormalTok{ load}\OtherTok{(}\NormalTok{ObjectManager }\KeywordTok{$manager}\OtherTok{)}
\NormalTok{    \{}
        \KeywordTok{$product1}\NormalTok{ = }\KeywordTok{new}\NormalTok{ Product}\OtherTok{();}
        \KeywordTok{$product1}\NormalTok{->setName}\OtherTok{(}\StringTok{'hammer'}\OtherTok{);}
        \KeywordTok{$manager}\NormalTok{->persist}\OtherTok{(}\KeywordTok{$product1}\OtherTok{);}

        \KeywordTok{$product2}\NormalTok{ = }\KeywordTok{new}\NormalTok{ Product}\OtherTok{();}
        \KeywordTok{$product2}\NormalTok{->setName}\OtherTok{(}\StringTok{'plunger'}\OtherTok{);}
        \KeywordTok{$manager}\NormalTok{->persist}\OtherTok{(}\KeywordTok{$product1}\OtherTok{);}
...
Now we need to also create 2 \texttt{Category} objects by getting the 2
named references:
...
\NormalTok{    \{}
        ...
        \CommentTok{// create named references}
        \KeywordTok{$cat1}\NormalTok{ = }\KeywordTok{$this}\NormalTok{->getReference}\OtherTok{(}\StringTok{'CATEGORY_HARDWARE'}\OtherTok{);}
        \KeywordTok{$cat2}\NormalTok{ = }\KeywordTok{$this}\NormalTok{->getReference}\OtherTok{(}\StringTok{'CATEGORY_KITCHENWARE'}\OtherTok{);}

        \KeywordTok{$product1}\NormalTok{ = }\KeywordTok{new}\NormalTok{ Product}\OtherTok{();}
        \KeywordTok{$product1}\NormalTok{->setName}\OtherTok{(}\StringTok{'hammer'}\OtherTok{);}
        \KeywordTok{$product1}\NormalTok{->setCategory}\OtherTok{(}\KeywordTok{$cat1}\OtherTok{);}
        \KeywordTok{$manager}\NormalTok{->persist}\OtherTok{(}\KeywordTok{$product1}\OtherTok{);}

        \KeywordTok{$product2}\NormalTok{ = }\KeywordTok{new}\NormalTok{ Product}\OtherTok{();}
        \KeywordTok{$product2}\NormalTok{->setName}\OtherTok{(}\StringTok{'plunger'}\OtherTok{);}
        \KeywordTok{$product2}\NormalTok{->setCategory}\OtherTok{(}\KeywordTok{$cat2}\OtherTok{);}
        \KeywordTok{$manager}\NormalTok{->persist}\OtherTok{(}\KeywordTok{$product2}\OtherTok{);}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/ed6d8371de7dcb3e493e014fbec0f0051aed1765.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/0db6711a872d0c20b95c1795724d81774c2e5c14.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/ca3a96067d2a7b1d92cc60f542cb170bf7dc8563.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/15a6d51f6220970d5520415ccb4864ae58ae9ad9.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/f9087b127b21a746a42bee0755ac2abfb144b89c.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/b7aec3203c234fdc0b487b9331755c42a04f3b27.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/d0d0a0c5c02cdeae130278796b262303df02b576.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/7ce4ab3158613594bcaaa31601e404c70d3d4ed4.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/5ea70cd464c7a89a545b4379c487d35b9097eec5.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/269f5b90ef563d270e48d48cca61d6c2b172ee39.png}
\caption{Animated hamburger links for narrow browser window.
\label{query1}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/6ede346171ac54e4c3de8392100951d14bee3666.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/9514eae2fe53ea5066a6bfb263d5fac802af022a.png}
\caption{Only \texttt{tools} Products. \label{query3}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/7a346ce12ff5373b1976ddd46a0c555b94f421c1.png}
\caption{Only \texttt{hardware} Products. \label{query4}}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/f58a05139ec5ba921032e06d20b97101894c9079.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/47650a0958b4a5fc995d0cc457a8d66e72541eae.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/8fc967e92395014712f6bdca2d15969781702e4c.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/7fa5d9dcad73af22289403074f4721ab58701320.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/1aca0e32b45d577ec003c85e186871abd9ba9b56.png}
\caption{Homepage with session colours applied via CSS.
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/84418b741d2d437a7bbca9010525e518fbcdd4de.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/54acc690157f03f68d7c8277dc141f8b570861fa.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/ca3e9c1fec1e44180d0d9921c1436d7d8338d566.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/1f857b19819be887adb09dafdce063deff3936e3.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/6888b9386404a3f170783e9672b48cf40ecc274c.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/63b5ae9f82867fc51df48c24966ee9fcfd7c738c.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/e0059108995273ffa1150aad93ab2af90f546186.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/f181b091bf6a4a0a60d5cb4a8121508d7ac4b938.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/6ae94af6a6d64805890fbeb693bf09927b28b8c9.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/f4cc4aaf3249bfde725a7e233578eed13886be41.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/5d7967da5faff673e42573d187ad5b911c5112c2.png}
\caption{Screenshot of Custom Twig access denied page.
\label{denied_log}}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/df4541901cd35983e7beb2048b210fa5f1087755.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/2404dfd6a394c9f1aedb6443b74ebf498abf0705.png}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/37775f03f58d57201d8d743fdd9e86349205c708.png}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth,height=\textheight]{./tex2pdf.-8aed53dcd332a606/49ec37103f4f81567fa2694c122b38f522d2b6be.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/8ca93997f444ca616cd3203a26c977fbf5b2792c.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/4ddf85c5125b25530a9a963f1fd98b09b5395541.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/626240e41f67751ae615eb9716ffa2d9f783b847.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606/64817d6401ff5203679c0f96b7a8dfe87177e70d.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-8aed53dcd332a606