...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/06166ca531c57ddfbf4405cd4fecb47fcec83322.png}
...
\NormalTok{    [}\ExtensionTok{OK}\NormalTok{]                                         }
   ...
   \ExtensionTok{Note}\NormalTok{  The command console can use a different php.ini file}
   \ExtensionTok{~~~~}  \ExtensionTok{than}\NormalTok{ the one used by your web server.}
         \ExtensionTok{Please}\NormalTok{ check that both the console and the web server}
         \ExtensionTok{are}\NormalTok{ using the same PHP version and configuration.}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/990c4162a5e84b44da4e3d7eeed5f985f5c32d3f.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/589be243de6474b6ef708d87dd3912d163d0d387.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/2a799b2bfbfc4e78e4f9c5ad9ef60b948c664efb.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/f35d637c8c0cd9aaebc6b1e793c0ee9634295185.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/b06182fc0ed292ee74b2047d002be6e027d35847.png}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/aaf51436dc412e0d900f6fdaa3f2a64f78164437.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/413bb0447c351895d20b9303f385a53ed285ce1c.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/80f2f3cd8caabc570fcf1ded7463dba5c252e430.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/aab43016ca92f606223ed7ec25a287137c41efb1.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/6b159751d9c0958cc96a4f18f6854eecfebbcd1c.png}
...
\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/784a3214b2c9d666848fc3381f2941d84684d258.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/2cc70a146aed6ecf5eeae774f90c0d07909e8e39.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/06166ca531c57ddfbf4405cd4fecb47fcec83322.png}
\caption{Screenshot showing new Student form with Campus choice dropdown
menu}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/5bc94e0457a935182217cbb4702da1ad3e17aea2.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/20b62a1322e7bb7bd3888a6c41b5b13e8d2a6fda.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/84227cafca4ff9fdb2c37c865008a110e806146d.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/efde51f7e3e51617cda6a160a7ed0e2815fed62f.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-b567767c1af560fd/d15dac2f92333b46b15f191d1fa01d46678cadf6.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/040745e54c86e866f7782a8288615596ca63acd8.png}
...
\begin{figure}
\centering
\includegraphics[width=0.75\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/8f5dcdf1f9bda61a8f9da909f3ba2f3d18d77cac.png}
...
the \texttt{src/DataFixtures} directory are executed.
...
\texttt{use} statement for the \texttt{IsGranted} class, and single PHP
8 atribute line immediately before the declaration of class file
\texttt{src/Controller/UserController.php}:

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/9a73b9314ee3601e17eb6b752b78f254c6539ed8.png}
...
login. See Figure \ref{login}. Symfony has seen the security requirement
that only users with \texttt{ROLE\_ADMIN} security are permitted to
access the \texttt{User} CRUD controller methods, and so has
automatically redirected to the login form page.

\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/dfbc39d266ca1d8b1fbd80ce0fe76702d4fb92f1.png}
...
\begin{Shaded}
\begin{Highlighting}[]
    \ExtensionTok{%}\NormalTok{ symfony console ma:fa }
...
\NormalTok{      [}\ExtensionTok{1}\NormalTok{] App\textbackslash{}Entity\textbackslash{}Student}
     \OperatorTok{>} \ExtensionTok{0}
    
     \ExtensionTok{created}\NormalTok{: src/Factory/CampusFactory.php}
      \ExtensionTok{Success}\NormalTok{! }
...
\NormalTok{    \{}
        \KeywordTok{public} \KeywordTok{function}\NormalTok{ load}\OtherTok{(}\NormalTok{ObjectManager }\KeywordTok{$manager}\OtherTok{)}\NormalTok{: }\KeywordTok{void}
\NormalTok{        \{}
            \StringTok{...}\NormalTok{ existing code }\StringTok{...}
...
Since we are only populating the single string property
\texttt{location} for each new \texttt{Campus} object, we can create
each new object in a single line.

Let's reset the database contents and load the fixtures from this
\texttt{AppFixtures} class. We use the CLI command
\texttt{doctrine:fixtures:load} (or \texttt{do:fi:lo}). You'll get a
warning and have to type \texttt{y} to confirm you are \textbf{purging}
(deleting!) all existing data from the database, and then loading new
data from the fixtures classes:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{    $ }\ExtensionTok{symfony}\NormalTok{ console do:fi:lo}
    
     \ExtensionTok{Careful}\NormalTok{, database }\StringTok{"crud01"}\NormalTok{ will be purged. Do you want to continue? (yes/no) [}\ExtensionTok{no}\NormalTok{]:}
     \OperatorTok{>} \ExtensionTok{y}
    
       \OperatorTok{>} \ExtensionTok{purging}\NormalTok{ database}
       \OperatorTok{>} \ExtensionTok{loading}\NormalTok{ App\textbackslash{}DataFixtures\textbackslash{}AppFixtures}
\end{Highlighting}
\end{Shaded}

If you run the web server and vist \texttt{/campus} now you'll see these
3 \texttt{Campus} objects listed in the browser. See Figure
\ref{campus_fixtures} for a screenshot of the fixture data created.

\begin{figure}
\centering
\includegraphics[width=1\textwidth,height=\textheight]{./tex2pdf.-b567767c1af560fd/b6701d2893906ffcb97db6153c0bce6087241a3e.png}
\caption{Browser listing fixture \texttt{Campus}
objects.\label{campus_fixtures}}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{        $ }\ExtensionTok{symfony}\NormalTok{ console make:controller DefaultController}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-b567767c1af560fd/54ea2bd7518c42f7055083e08168bc8498c402b7.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-b567767c1af560fd/eb1ab9d21c784b824e4103ff64f0448e7b0e6122.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-b567767c1af560fd/23f96bdd9781fe840d266ef37cf21f53375d2ee1.png}
...
\begin{figure}
\centering
\includegraphics{./tex2pdf.-b567767c1af560fd/1d5fcbd6fa656ccd94d4e29a62daf0a1df5dae28.png}
